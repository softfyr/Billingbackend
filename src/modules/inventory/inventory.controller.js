...
export const handleUpdateStockManual = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, result, 'Stock updated manually successfully.'));
});
...
export const handleGetExpiryAlerts = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, alerts, 'Expiry alerts fetched successfully.'));
});
...
export const handleExportInventoryLogs = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, exportData, 'Inventory audit logs export dataset generated successfully.'));
});
